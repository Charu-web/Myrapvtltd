...
export default function Sidebar() {
  ...
  const [active, setActive] = useState('Catering')
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="sticky top-4 hidden h-[calc(100vh-2rem)] flex-col rounded-2xl bg-gradient-to-b from-brand-red via-brand-redDark to-brand-redDeep py-4 shadow-card md:ml-4 md:flex"
      >
