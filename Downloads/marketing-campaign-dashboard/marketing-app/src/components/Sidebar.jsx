...
const NAV_ITEMS = [
  ...
  { label: 'Marketing', icon: Megaphone, active: true },
  ...
  return (
    <>
      <motion.aside
        ...
        className="relative hidden shrink-0 flex-col rounded-2xl bg-gradient-to-b from-sidebar-from to-sidebar-to
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              exit={{ x: -280 }}
              transition={{ duration: 0.25, ease: 'easeInOut' }}
              className="fixed inset-y-0 left-0 z-50 flex w-[264px] flex-col rounded-r-2xl bg-gradient-to-b
