...
// BEFORE express.json() and use its own route (not under /api/orders router).
...
// --- Static file serving (product/category/gallery images seeded to disk) ---
// In production, swap this for Cloudinary URLs — this exists so the catalog
// has real, working images without requiring Cloudinary API keys to be set up first.
app.use(
  '/uploads',
